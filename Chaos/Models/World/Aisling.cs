...
public sealed class Aisling : Creature, IScripted<IAislingScript>, IDialogSourceEntity, ICommandSubject, IChannelSubscriber
{
        ...
        : this(name, mapInstance, point)
    {
        ...
        ScriptKeys = new HashSet<string>
        {
            ...
            ScriptBase.GetScriptKey(typeof(BerserkerUnbrokenScript)),
            ScriptBase.GetScriptKey(typeof(BerserkerCarnageScript)),
            ScriptBase.GetScriptKey(typeof(MartialArtistChiScript)),
            ScriptBase.GetScriptKey(typeof(LancerShieldScript)),
            ScriptBase.GetScriptKey(typeof(GuardiansResolveScript)),
            ...
            ScriptBase.GetScriptKey(typeof(SpiritualAttunementScript)),
            ScriptBase.GetScriptKey(typeof(BedrockScript)),
            ScriptBase.GetScriptKey(typeof(FlowingChiScript)),
            ScriptBase.GetScriptKey(typeof(PerfectRhythmScript)),
            ScriptBase.GetScriptKey(typeof(OneWithTheWindScript)),
