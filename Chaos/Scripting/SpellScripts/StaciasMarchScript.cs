...
/// <summary>
///     Applies <see cref="MarchEffect" /> to every friendly Aisling on the map - same pattern as
///     <see cref="StaciasBlessingScript" />
/// </summary>
public class StaciasMarchScript : ConfigurableSpellScriptBase
{
    /// <inheritdoc />
    public StaciasMarchScript(Spell subject)
        : base(subject) { }
    ...
    public override void OnUse(SpellContext context)
    {
        ...
        foreach (var aisling in map.GetEntities<Aisling>())
        {
            ...
            var marchEffect = new MarchEffect { AtkSpeedBonus = AtkSpeedBonus };
            marchEffect.SetDuration(TimeSpan.FromMilliseconds(DurationMs));
            aisling.Effects.Apply(source, marchEffect, this);
        }
    ...
    public int AtkSpeedBonus { get; init; } = 20;
