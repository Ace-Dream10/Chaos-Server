...
/// <summary>
///     Three sweeping glaive strikes. Not one of Valkyrie's 6 evolving abilities - flat numbers, per the locked
///     design. Mirrors <see cref="FlourishScript" />'s multi-hit-on-the-tile-ahead shape (minus the Severance
///     stack generation, which is Slayer-specific).
/// </summary>
public class DreamslashScript : ConfigurableSkillScriptBase
{
    private readonly List<PendingHit> PendingHits = [];

    /// <inheritdoc />
    public DreamslashScript(Skill subject)
        : base(subject)
    ...
    /// </summary>
    public int HitCount { get; init; } = 3;
