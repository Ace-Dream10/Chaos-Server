...
public class RagnarokScript : ConfigurableSkillScriptBase
{
    ...
    public override void OnUse(ActivationContext context)
    {
        ...
        var damage = (BaseDamage ?? 0) + Convert.ToInt32(currentMp * FuryMultiplier);
    ...
    /// <summary>
    ///     The flat portion of the damage dealt, before fury scaling
    /// </summary>
    ...
    /// </summary>
    public decimal FuryMultiplier { get; init; } = 1;
