...
public class ValkyriesCallScript : ConfigurableSkillScriptBase
{
    private const int PullRange = 2;

    /// <inheritdoc />
    public ValkyriesCallScript(Skill subject)
        : base(subject) { }
    ...
    /// <summary>
    ///     The filter used to determine which creatures within pull range are valid targets
    /// </summary>
    ...
    /// </summary>
    public int MaxTargets { get; init; } = 4;
